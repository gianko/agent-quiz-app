...
**For frontend code**: use red/green/refactor for hooks, state logic, and utility functions — same loop as backend. For pure UI components, implement directly then add a smoke test. For user-facing flows, add an e2e test after the feature works.
